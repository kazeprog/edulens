    ...
    >
      ...
      >
        ...
        <div className="z-10 text-center w-full">
          ...
          <h1 className="text-4xl font-extrabold text-slate-800 mb-6 tracking-tight overflow-hidden text-ellipsis whitespace-nowrap px-4">{examName}</h1>
      ...
      >
        ...
        <div className="z-10 text-center w-full">
          <h2 className="text-2xl font-bold text-slate-500 mb-4">{sessionName}</h2>
          <h1 className="text-4xl font-extrabold text-slate-800 mb-8 tracking-tight overflow-hidden text-ellipsis whitespace-nowrap px-4">{examName}</h1>
      ...
      >
        <div className="text-center">
          ...
          <h1 className="text-4xl font-extrabold text-slate-900 mb-2 leading-tight overflow-hidden text-ellipsis whitespace-nowrap px-2">{examName}</h1>
