    ...
    return (
        <TextbookLPTemplate
            ...
            seoSettings={{
                ...
                heroDescription: "大学受験の古文対策に使える「ベストセレクション 古文単語325」対応の無料古文単語テスト・学習アプリ感覚ページです。章ごとに重要語を確認でき、登録不要ですぐ復習を始められます。",
                ...
                featuresDescription: (
                    <p>
                        ...
                        合格に必要な古文単語を、小テストとアプリ感覚の反復で確実に定着させる「古文単語テスト作成サイト」です。
                    </p>
                ),
                feature1: {
                    title: "章別小テスト",
