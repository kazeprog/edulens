...
export const metadata: Metadata = {
    ...
    description: 'ベストセレクション 古文単語325を無料で学習。章・番号範囲・問題数・回答方式を選んで古文単語テストを開始し、苦手語、学習履歴、正答率まで確認できます。',
    keywords: [
        '古文単語325',
        'ベストセレクション',
        'マドンナ古文',
...
export default function Kobun325Page() {
    return (
        <TextbookLPTemplate
            ...
            audience="senior"
            bookType="wordbook"
            overrideCoverTitle="ベストセレクション 325"
            seoSettings={{
                heroTitle: (
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-800 leading-tight tracking-tight">
                        <span className="block text-xl md:text-2xl font-bold text-emerald-600 mb-4 tracking-normal">ベストセレクション 古文単語325対応</span>
                        重要古文単語を<br />
                        <span className="text-emerald-500">章別テストで定着確認</span>
                    </h1>
                ),
                heroDescription: "大学受験の古文対策に使える「ベストセレクション 古文単語325」対応の無料古文単語テストページです。章ごとに重要語を確認でき、登録不要ですぐ復習を始められます。",
                testSectionTitle: "古文単語325の古文単語テストを無料で作成",
                testSectionDescription: (
                    <p>
                        面倒な会員登録は不要。章を選ぶだけで、誰でも無料で古文単語の小テストが作れます。<br />
                        <strong>ベストセレクション古文単語325</strong>を選択して古文単語テストを始めてください。
                    </p>
                ),
                ...
                featuresDescription: (
                    <p>
                        ...
                        合格に必要な古文単語を、章別の小テストで確実に定着させる「古文単語テスト作成サイト」です。
                    </p>
                ),
                feature1: {
                    title: "章別小テスト",
                    description: "古文単語325の目次通りの順番でテストが可能。学校の小テスト対策から、入試直前の総確認まで対応しています。"
                },
                feature2: {
                    title: "苦手単語を自動でリスト化",
