...
export const metadata: Metadata = {
    title: '古文単語325（ベストセレクション/マドンナ）単語テスト｜大学受験 無料',
            ...
            seoSettings={{
                heroTitle: (
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-800 leading-tight tracking-tight">
                        <span className="block text-xl md:text-2xl font-bold text-emerald-600 mb-4 tracking-normal">ベストセレクション 古文単語325 完全対応</span>
                        重要古文単語を<br />
                        <span className="text-emerald-500">ゲーム感覚で完全攻略</span>
                    </h1>
                ),
                heroDescription: "大学受験の古文対策「ベストセレクション 古文単語325」の無料テスト・クイズアプリ（サイト）。章ごとに小テストを作成でき、共通テストや中堅大の古文単語対策に最適です。登録不要で今すぐテスト作成・実施が可能！",
                testSectionTitle: "古文単語325のテスト作成",
                testSectionDescription: (
                    <p>
                        面倒な会員登録は不要。章を選ぶだけで、誰でも無料で古文単語の小テストが作れます。<br />
                        選択肢から「単語帳テスト」を選んで、<strong>ベストセレクション古文単語325</strong>を選択してください。
                    </p>
                ),
                ...
                featuresDescription: (
                    <p>
                        ...
                        合格に必要な古文単語を確実に定着させる「古文単語テスト作成サイト」です。
                    </p>
                ),
                feature1: {
                    title: "章別小テスト",
