...
export const metadata: Metadata = {
    ...
    description: 'ターゲット1800 5訂版を無料で学習。Section・番号範囲・問題数・回答方式を選んで高校入試向け小テストを開始し、苦手単語、学習履歴、正答率まで確認できます。',
    keywords: [
        'ターゲット1800(5訂版)',
        'ターゲット1800 5訂版',
        '中学英単語 ターゲット1800(5訂版)',
    ...
    return (
        <TextbookLPTemplate
            ...
            seoSettings={{
                ...
                heroDescription: "高校入試対策に使える「ターゲット1800(5訂版)」対応の無料英単語テストページです。中学重要単語を小テスト形式で確認でき、登録不要ですぐ復習を始められます。",
                ...
                featuresDescription: (
                    <p>
                        ...
                        「ターゲット1800(5訂版)」の内容を確実に定着させるための機能を備えています。毎日の復習にブラウザで使えます。
                    </p>
                ),
                feature1: {
                    title: "番号別小テスト",
