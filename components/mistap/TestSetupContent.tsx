                ...
                <div className="relative">
                  ...
                  >
                    {level === "junior" ? (
                      ...
                      <>
                        <optgroup label="📖 英単語">
                          {["LEAP", "改訂版 必携英単語LEAP", "ターゲット1200", "ターゲット1400", "システム英単語", "システム英単語 Stage5", "ターゲット1900", "DUO 3.0例文", "改訂版 鉄緑会東大英単語熟語 鉄壁"]
                            .filter(text => texts.includes(text))
                            .map(text => (
                              <option key={text} value={text} translate="no">{text}</option>
                            ))}
                        ...
                        {(!["LEAP", "改訂版 必携英単語LEAP", "ターゲット1200", "ターゲット1400", "システム英単語", "システム英単語 Stage5", "ターゲット1900", "DUO 3.0例文", "改訂版 鉄緑会東大英単語熟語 鉄壁"].some(t => texts.includes(t)) && !["読んで見て聞いて覚える 重要古文単語315", "Key＆Point古文単語330", "ベストセレクション古文単語325", "理解を深める核心古文単語351", "マドンナ古文単語230", "GROUP30で覚える古文単語600"].some(t => texts.includes(t))) && (
                          <>
                            {texts.map(text => (
                              <option key={text} value={text} translate="no">{text}</option>
                            ))}
