                ...
                <div className="relative">
                  ...
                  >
                    {level === "junior" ? (
                      ...
                      <>
                        <optgroup label="📖 英単語">
                          {["LEAP", "LEAP Basic", "改訂版 必携英単語LEAP", "ターゲット1200", "ターゲット1400", "英熟語ターゲット1000 5訂版", "システム英単語", "システム英単語Basic〈5訂版〉", "システム英熟語〈5訂版〉", "システム英単語 Stage5", "ターゲット1900", "Stock3000", "Stock4500", "速読英単語　必修編 ［改訂第８版］", "速読英単語　上級編［改訂第５版］", "英検準2級 でる順パス単 5訂版", "英検2級 でる順パス単 5訂版", "英検準1級単熟語EX", "DUO 3.0例文", "改訂版 鉄緑会東大英単語熟語 鉄壁"]
                            .filter(text => texts.includes(text))
                            .map(text => (
                              <option key={text} value={text} translate="no">{text}</option>
                            ))}
                        ...
                        <optgroup label="📜 古文単語">
                          {["読んで見て聞いて覚える 重要古文単語315", "Key＆Point古文単語330", "ベストセレクション古文単語325", "理解を深める核心古文単語351", "大学入試 新古文単語336", "マドンナ古文単語230", "GROUP30で覚える古文単語600"]
                            .filter(text => texts.includes(text))
                            .map(text => (
                              <option key={text} value={text} translate="no">{text}</option>
                            ))}
                        ...
                        {(!["LEAP", "LEAP Basic", "改訂版 必携英単語LEAP", "ターゲット1200", "ターゲット1400", "英熟語ターゲット1000 5訂版", "システム英単語", "システム英単語Basic〈5訂版〉", "システム英熟語〈5訂版〉", "システム英単語 Stage5", "ターゲット1900", "Stock3000", "Stock4500", "速読英単語　必修編 ［改訂第８版］", "速読英単語　上級編［改訂第５版］", "英検準2級 でる順パス単 5訂版", "英検2級 でる順パス単 5訂版", "英検準1級単熟語EX", "DUO 3.0例文", "改訂版 鉄緑会東大英単語熟語 鉄壁"].some(t => texts.includes(t)) && !["読んで見て聞いて覚える 重要古文単語315", "Key＆Point古文単語330", "ベストセレクション古文単語325", "理解を深める核心古文単語351", "大学入試 新古文単語336", "マドンナ古文単語230", "GROUP30で覚える古文単語600"].some(t => texts.includes(t))) && (
                          <>
                            {texts.map(text => (
                              <option key={text} value={text} translate="no">{text}</option>
                            ))}
