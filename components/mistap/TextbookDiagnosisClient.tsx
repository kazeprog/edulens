...
const books: BookRecommendation[] = [
    ...
    },
    {
        ...
        shortName: '熟語ターゲット1000',
        amazonQuery: '英熟語ターゲット1000 5訂版',
        mistapPath: '/mistap/textbook/idiom-target-1000-5th',
        levelLabel: 'でる順の英熟語対策',
        summary: '入試頻出の英熟語を、短い範囲でテンポよく反復したい人に向いています。',
        strategy: 'まずは100項目ずつMistapで確認し、間違えた熟語だけを翌日に回すと定着しやすいです。',
        strengths: ['でる順で進めやすい', '短時間で反復しやすい', '共通テストから私大対策まで使える'],
        rules: {
            grade: { high2: 4, high3: 4 },
            goal: { common_test: 3, mid_uni: 4, difficult_uni: 3 },
            level: { basic: 3, standard: 4, advanced: 2 },
            style: { quick: 4, coverage: 3 },
        },
    },
    {
        name: 'システム英単語',
    ...
    },
    {
        ...
        shortName: 'シス単Basic',
        amazonQuery: 'システム英単語Basic〈5訂版〉',
        mistapPath: '/mistap/textbook/system-words-basic-5th',
        levelLabel: '高校基礎から受験標準へ',
        summary: '基礎レベルから受験頻出語へ橋渡ししたい人に向いています。',
        strategy: '最初は100語単位で小テストを作り、正答率が安定した範囲から次へ進みましょう。',
        strengths: ['基礎を固めやすい', 'シス単に入りやすい', '高1・高2の土台作りに合う'],
        rules: {
            grade: { high1: 5, high2: 3, junior: 2 },
            goal: { regular_exam: 4, common_test: 3 },
            level: { weak: 5, basic: 4 },
    ...
    },
    {
        name: 'システム英熟語〈5訂版〉',
        shortName: 'シス熟',
        amazonQuery: 'システム英熟語〈5訂版〉',
        mistapPath: '/mistap/textbook/system-english-idioms-5th',
        levelLabel: '大学受験の英熟語対策',
        summary: '句動詞や前置詞表現を体系的に整理しながら、入試頻出の熟語を固めたい人に向いています。',
        strategy: '単語帳と並行して、英熟語だけを100項目ずつMistapで確認すると読解の取りこぼしを減らしやすいです。',
        strengths: ['句動詞に強くなる', '前置詞表現を整理しやすい', '読解・英作文にもつながる'],
        rules: {
            grade: { high2: 3, high3: 4 },
            goal: { common_test: 2, mid_uni: 4, difficult_uni: 4 },
            level: { basic: 2, standard: 4, advanced: 3 },
            style: { coverage: 4, context: 3 },
        },
    },
    {
        name: 'LEAP Basic',
