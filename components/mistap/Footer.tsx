    ...
    return (
        <footer className="w-full py-8 text-center border-t border-red-100 bg-gradient-to-b from-white to-red-50/30">
            <nav className="flex flex-wrap justify-center gap-6 mb-4 text-sm text-gray-500">
                ...
                <Link href="/mistap/contact" prefetch={false} className="hover:text-red-600 hover:underline transition-colors">お問い合わせ</Link>
                <Link href="/mistap/blog" prefetch={false} className="hover:text-red-600 hover:underline transition-colors">ブログ</Link>
                <Link href="/mistap/about" prefetch={false} className="hover:text-red-600 hover:underline transition-colors">Mistapとは</Link>
                <Link href="/operator" prefetch={false} className="hover:text-red-600 hover:underline transition-colors">運営者情報</Link>
            </nav>
