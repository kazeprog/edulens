...
export const AMAZON_TEXTBOOKS = {
  ...
  idiomTarget1000: {
    title: '英熟語ターゲット1000 5訂版',
    searchQuery: '英熟語ターゲット1000 5訂版',
    asin: '4010346493',
    isbn13: '9784010346495',
    publisher: '旺文社',
    edition: '5訂版',
  },
  target1800: {
  ...
  systemWordsBasic: {
    ...
    searchQuery: 'システム英単語Basic〈5訂版〉',
    asin: '4796111417',
    isbn13: '9784796111416',
    publisher: '駿台文庫',
    edition: '5訂版',
  },
  systemEnglishIdioms: {
    title: 'システム英熟語〈5訂版〉',
    searchQuery: 'システム英熟語〈5訂版〉',
    asin: '479611145X',
    isbn13: '9784796111454',
    publisher: '駿台文庫',
    edition: '5訂版',
  },
  leap: {
...
const AMAZON_TEXTBOOK_ALIASES: Record<string, AmazonTextbookKey> = {
  ...
  '英熟語ターゲット1000 5訂版': 'idiomTarget1000',
  '英熟語ターゲット1000［5訂版］': 'idiomTarget1000',
  '英熟語ターゲット1000[5訂版]': 'idiomTarget1000',
  英熟語ターゲット1000: 'idiomTarget1000',
  ...
  'システム英単語Basic〈5訂版〉': 'systemWordsBasic',
  'システム英単語Basic 5訂版': 'systemWordsBasic',
  'システム英単語 Basic 5訂版': 'systemWordsBasic',
  システム英単語Basic: 'systemWordsBasic',
  'システム英単語 Basic': 'systemWordsBasic',
  シス単Basic: 'systemWordsBasic',
  'シス単 Basic': 'systemWordsBasic',
  シスタンベーシック: 'systemWordsBasic',
  'System English Word Basic': 'systemWordsBasic',
  'システム英熟語〈5訂版〉': 'systemEnglishIdioms',
  'システム英熟語 5訂版': 'systemEnglishIdioms',
  システム英熟語: 'systemEnglishIdioms',
  シス熟: 'systemEnglishIdioms',
  'System English Idioms': 'systemEnglishIdioms',
  LEAP: 'leap',
  '必携英単語LEAP': 'leap',
  '必携英単語 LEAP': 'leap',
