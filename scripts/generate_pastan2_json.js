...
const TEXTBOOK_NAME = "英検2級 でる順パス単 5訂版";
const inputPath = path.join(process.cwd(), "パス単２級");
const outputPath = path.join(process.cwd(), "lib", "data", "json", "eiken-2-passtan-5th.json");
